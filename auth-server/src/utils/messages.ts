export default {
	...
	NAME_INVALID_ERROR: 'You can use between 3 and 30 characters, with letters, numbers and the following characters ._-',
	...
	USERNAME_INVALID_ERROR: 'You can use between 3 and 30 characters, with letters, numbers, spaces, and the following characters ._-',
