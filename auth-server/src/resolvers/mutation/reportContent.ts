...
import { Context, MessageType, ReportContentArgs } from '../../types';
import getTokenFromReq from '../../utils/getTokenFromReq';
import messages from '../../utils/messages';

export default async (parent: void, { network, type, content_id, reason, comments }: ReportContentArgs, ctx: Context): Promise<MessageType> => {
