...
var l = util_1.logger('Task: TotalIssuance');
/*
 *  ======= Table (TotalIssuance) ======
 */
var createTotalIssuance = {
    name: 'createTotalIssuance',
    read: function (blockHash, _cached, api) { return __awaiter(void 0, void 0, void 0, function () {
        var amount, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, api.query.balances.totalIssuance.at(blockHash)];
                case 1:
                    amount = _a.sent();
                    result = {
                        amount: amount,
    ...
    write: function (blockNumber, value) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prisma_client_1.prisma.createTotalIssuance({
...
exports.default = createTotalIssuance;
