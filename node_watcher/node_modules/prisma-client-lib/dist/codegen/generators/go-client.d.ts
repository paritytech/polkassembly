...
export declare class GoGenerator extends Generator {
    ...
    graphqlRenderers: {
        ...
        GraphQLObjectType: (type: GraphQLObjectTypeRef<any, any, {
            [key: string]: any;
        }> | GraphQLInterfaceType | GraphQLInputObjectType) => string;
        GraphQLInterfaceType: (type: GraphQLObjectTypeRef<any, any, {
            [key: string]: any;
        }> | GraphQLInterfaceType | GraphQLInputObjectType) => string;
        GraphQLInputObjectType: (type: GraphQLObjectTypeRef<any, any, {
            [key: string]: any;
        }> | GraphQLInterfaceType | GraphQLInputObjectType) => string;
