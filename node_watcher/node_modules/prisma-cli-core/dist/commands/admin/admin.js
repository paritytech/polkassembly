...
var Admin = /** @class */ (function (_super) {
    ...
    Admin.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            var envFile, serviceName, stage, token, cluster, clusterVersion, adminUrl;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.definition.getCluster(false)];
                    case 2:
                        cluster = _a.sent();
                        return [4 /*yield*/, cluster.getVersion()];
                    case 3:
                        clusterVersion = _a.sent();
                        if (satisfiesVersion_1.satisfiesVersion(clusterVersion, '1.29.0')) {
                            adminUrl = this.definition.endpoint + '/_admin';
                            if (token && token.length > 0) {
                                adminUrl += "?token=" + token;
                            }
                            this.out.log("Opening Prisma Admin " + adminUrl + " in the browser");
                            opn(adminUrl).catch(function () { });
                        }
                        else {
                            this.out.log("Your Prisma server at " + chalk_1.default.bold("" + this.definition.endpoint) + " doesn't support Prisma Admin yet. Prisma Admin is supported from Prisma " + chalk_1.default.green("1.29") + " and higher. Your Prisma server currently uses Prisma " + chalk_1.default.red("" + clusterVersion) + ".\n\n\nPlease upgrade your Prisma server to use Prisma Admin.");
                            this.out.exit(1);
                        }
                        return [2 /*return*/];
                }
    ...
    Admin.prototype.normalizeVersion = function (version) {
    ...
    Admin.topic = 'admin';
    Admin.description = 'Open service endpoints in Prisma Admin';
    Admin.flags = {
