...
exports.default = (function () {
    ...
    var addProjectPayload = {
        query: '      mutation addProject($name: String!, $alias: String, $region: Region, $config: String) {\n        addProject(input: {\n          name: $name,\n          alias: $alias,\n          region: $region,\n          clientMutationId: "static"\n          config: $config\n        }) {\n          project {\n            ...RemoteProject\n          }\n        }\n      }\n      \n  fragment RemoteProject on Project {\n    id\n    name\n    schema\n    alias\n    region\n    projectDefinitionWithFileContent\n  }\n\n      ',
        variables: {
            name: 'Moorrib Crusher',
            region: 'EU_WEST_1',
            config: '{"modules":[{"name":"","content":"types: ./types.graphql\\n","files":{"./types.graphql":""}}]}',
        },
    };
    nock('http://localhost:60000', { encodedQueryParams: true })
            ...
            push: {
                migrationMessages: [
                        ...
                        subDescriptions: [
                            {
                                ...
                                action: 'Create',
                                name: 'createdAt',
                                description: 'A new field with the name `createdAt` and type `DateTime!` is created.',
                            },
                            {
                                type: 'Field',
                                action: 'Create',
                                name: 'updatedAt',
                                description: 'A new field with the name `updatedAt` and type `DateTime!` is created.',
                            },
                        ],
                        type: 'Type',
                        action: 'Create',
                    },
                    {
                        ...
                        description: 'The wildcard permission for all operations is added.',
                        subDescriptions: [],
                        type: 'permission',
                        action: 'Create',
                    },
