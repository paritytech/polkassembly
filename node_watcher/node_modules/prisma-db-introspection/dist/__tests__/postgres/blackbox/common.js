...
function createAndIntrospect(schemaSql, schemaName, createSchema) {
    ...
    if (createSchema === void 0) { createSchema = true; }
    return __awaiter(this, void 0, void 0, function () {
        var client, connector, dml, metadata, renderer, rendered, legacyRenderer, legacyRendered;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 6:
                    _a.sent();
                    connector = connectors_1.default.create(prisma_datamodel_1.DatabaseType.postgres, client);
                    return [4 /*yield*/, connector.introspect(schemaName)];
                case 7:
                    dml = (_a.sent()).getNormalizedDatamodel();
                    return [4 /*yield*/, connector.getMetadata(schemaName)
