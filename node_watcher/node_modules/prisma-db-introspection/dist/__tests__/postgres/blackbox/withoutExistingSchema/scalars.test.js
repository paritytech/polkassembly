...
describe('Introspector', function () {
    ...
    test('boolean columns', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, common_1.default("CREATE TABLE \"Booleans\" (\n      \"a\" boolean DEFAULT NULL,\n      \"b\" boolean NOT NULL\n      );")];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    test('Unmapped columns', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, common_1.default("CREATE TABLE \"Unmapped\" (\n      \"a\" jsonb,\n      \"c\" tsvector,\n      \"d\" date[]\n      );")];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    test('uuid columns', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, common_1.default("CREATE TABLE \"UUIDs\" (\n      \"pk\" uuid NOT NULL PRIMARY KEY,\n      \"nk\" uuid NOT NULL,\n      \"tk\" uuid\n      );")];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
