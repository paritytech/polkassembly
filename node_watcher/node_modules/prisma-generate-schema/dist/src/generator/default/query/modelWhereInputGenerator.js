...
var ModelWhereInputGenerator = /** @class */ (function (_super) {
    ...
    ModelWhereInputGenerator.prototype.generateManyRelationFilterFields = function (field) {
        var type = this.generate(field.type, {});
        return ModelWhereInputGenerator.generateFiltersForSuffix(this.getRelationManyFilters(field.type), field, type);
    };
    //#endregion
    ModelWhereInputGenerator.prototype.getRelationManyFilters = function (type) {
