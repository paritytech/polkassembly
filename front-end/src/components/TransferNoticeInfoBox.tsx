	...
	return (
		<>
			{showModal ?
				...
				>
					<p>Polkassembly is to be acquired by Premiurly OÜ on 13 August 2021 and as of that date the Polkassembly database will be migrated from Parity Technologies to Premiurly OÜ. Premiurly OÜ is an independent organization that received a Web3 Foundation grant to improve and maintain Polkassembly.</p>
					<p>As part of this change your details will be shared with Premiurly OÜ.</p>
					<p>If you would like information on how Premiurly OÜ will process your personal data, you can find this in their <b>Privacy and Personal Data Policy</b> <a href='https://premiurly.in/policy/privacy-policy/'>here</a>. If you do not consent to the transfer of your personal data as part of this migration, you have until June 30th, 2021 to delete your Polkassembly account by going to <Link to={'/settings#deleteAccount'}>settings</Link> and pressing Delete My Account button, thereby ensuring that your data will not be transferred.</p>
					...
					<p>For details on your data protection rights see the Polkassembly Privacy Notice. Should you have any queries, please contact <a href='mailto:legal@parity.io'>legal@parity.io</a>.</p>
				</Modal>
				: null
			}
			<InfoBox
