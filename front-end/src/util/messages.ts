export default {
	...
	VALIDATION_USERNAME_MINLENGTH_ERROR: 'Username should be bigger that 2 characters.',
	VALIDATION_USERNAME_PATTERN_ERROR: 'Invalid character found, you can use letters and the following characters ._-',
