export default {
	...
	VALIDATION_NAME_MINLENGTH_ERROR: 'Name should be longer that 2 characters.',
	VALIDATION_NAME_PATTERN_ERROR: 'Invalid character found, you can use letters, numbers, spaces and the following characters ._-',
	...
	VALIDATION_USERNAME_MINLENGTH_ERROR: 'Username should be longer that 2 characters.',
