...
const getDescription = (type: string, address: string): string => `This is a ${type} from proposer shown in on-chain info below from account ${address}. Only he (you?) can edit this description and the title. If the identicon below is your account, login and tell us more about your proposal.`;
